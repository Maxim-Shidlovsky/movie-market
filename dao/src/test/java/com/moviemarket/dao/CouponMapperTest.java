...
public class CouponMapperTest {
    ...
    public void activateCouponTest() throws Exception {
        ...
        couponMapper.activateCoupon(TEST_COUPON.getCode(), TEST_USERNAME);
        OrderDTO order = orderMapper.getAllOrdersByUsername(TEST_USERNAME).get(0);
        MovieDTO movie = movieMapper.getMovieById(1);
