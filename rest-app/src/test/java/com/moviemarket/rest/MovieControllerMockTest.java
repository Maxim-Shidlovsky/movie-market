...
public class MovieControllerMockTest {
    ...
    private static final MovieDTO testMovie = new MovieDTO(1, "Terminator",
            new Date(84, 9, 26), 8, 5, 1, "Thriller");
    ...
    public void getMovieByIdTest() throws Exception {
        ...
        mockMvc.perform(
                get("/movie/" + testMovie.getMovieId())
                        .accept(MediaType.APPLICATION_JSON)
    ...
    public void getMovieByTitleTest() throws Exception {
        ...
        mockMvc.perform(
                get("/movie/title/" + testMovie.getTitle())
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
        ).andDo(print())
                .andExpect(status().isOk())
    ...
    public void getMoviesByCategoryIdTest() throws Exception {
        ...
        mockMvc.perform(
                get("/category/" + testMovie.getCategoryId() + "/movies")
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
        ).andDo(print())
                .andExpect(status().isOk())
    ...
    public void addMovieTest() throws Exception {
        ...
        expect(mockMovieService.addMovie(anyObject(Movie.class))).andReturn(3);
        replay(mockMovieService);
    ...
    public void updateMovieTest() throws Exception {
        ...
        expect(mockMovieService.updateMovie(anyObject(Movie.class))).andReturn(0);
        replay(mockMovieService);
    ...
    public void deleteMovieTest() throws Exception {
        ...
        expect(mockMovieService.deleteMovie(anyObject(Integer.class))).andReturn(0);
        replay(mockMovieService);
